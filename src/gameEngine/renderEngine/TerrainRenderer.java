...
/**
 * @author rtm592 The renderer for the terrain
 */
public class TerrainRenderer {
  ...
  /**
   * @param terrains
   *          the list of terrains to be rendered
   */
