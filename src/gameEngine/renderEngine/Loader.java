...
public class Loader {
	...
	public RawModel loadToVAO(float[] positions, float[] textureCoords, float[] normals, float[] tangents, int[] indicies) {
	...
	private TextureData decodeTextureFile(String file) {
		...
		try {
			...
			e.printStackTrace();
			System.err.println("tried to load no existent file");
			System.exit(-1);
		}
