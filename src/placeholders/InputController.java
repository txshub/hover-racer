...
public class InputController extends Thread {
  ...
  public enum Action {
    FORWARD, BREAK, STRAFE_LEFT, STRAFE_RIGHT, TURN_LEFT, TURN_RIGHT, JUMP, EXIT, MUSIC_UP,
    MUSIC_DOWN, MUSIC_SKIP, SFX_UP, SFX_DOWN;
  }

  private HashMap<Integer, Action> mapping; // Maps key codes to actions (can be
