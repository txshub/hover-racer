...
/** Container for information about a specific type of upgrade. Contains information about stats raised and costs of buying multiple levels
 * of this upgrade.
 * 
 * @author mxb551 */
public class UpgradeType {
	...
	/** Function that returns the cost of nth level of this upgrade. Leave null if cost is always equal to base cost */
	 ...
	 * 
	 * @param name Name of the upgrade, as shown to the player. Must be unique
	...
	public double getCost(int level) {
		if (level < 1)
			throw new IllegalArgumentException("Requested cost of " + name + " at level " + level + ". Level must be at least 1.");

		if (level > maxLevel && maxLevel > 0) return -1;
		else if (level == 1 || costFunction == null) return baseCost;
