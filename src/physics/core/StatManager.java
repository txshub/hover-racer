...
public class StatManager {
	...
	public StatManager(ShipTemplate template) {
		...
		this.AIR_RESISTANCE = 100f / stats.get(Stat.AERODYNAMICS);
		this.AIR_CUSHION = stats.get(Stat.MASS);
	...
	public final float AIR_RESISTANCE; // How fast do ships slow down (this and acceleration determines the max speed)
	...
	public final float AIR_CUSHION; // The base force of the ait cushion keeping the hovercraft in the air
	public final float CUSHION_SCALE = 0.8f;
	public final float JUMP_POWER; // Jumping, for science! (testing vertical stuff)
