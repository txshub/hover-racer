...
public class AIShip extends Ship {
	...
	public AIShip(byte id, TexturedModel model, Vector3f startingPosition, Collection<Ship> otherShips,
			GroundProvider ground, ArrayList<TrackPoint> track, InputController input) {
	...
	public void update(float delta) {
		...
		if (debug)
			System.out.println("Point: " + nextPointIndex + " - " + nextPoint + " Angle: " + angle + " Dist: " + dist
					+ " Thrust: " + thrust /*
											 * + " Pos: " + pos + " TPoint: " +
