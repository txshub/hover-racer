...
/**
 * ServerShipProvider that does nothing, i.e. acts as if no packets ever arrived from the server.
 * Used internally within the Ship class, otherwise to be only used for testing purposes
 * 
