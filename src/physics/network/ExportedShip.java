...
public class ExportedShip {
	...
	public static void main(String[] args) {
		...
		Ship testShip = new RemoteShip((byte) 2, null, new Vector3f(12, 7, 82), null, null);
		byte[] second = testShip.export();
		Ship receiver = new RemoteShip((byte) 2, null, new Vector3f(3, 4, 45), null, null);
		receiver.updateFromPacket(second);
		System.out.println(receiver.getPosition());
	}

	public static void printPacket(byte[] packet) {
		if (packet.length == 49) System.out.println(new ExportedShip(packet));
		...
		} else System.err.println("Invalid packet length: " + packet.length);
	}
