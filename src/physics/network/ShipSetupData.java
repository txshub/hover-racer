...
/**
 * Data about a ship, sent to the server from each client before the start of the game. All of them
 * are then sent back to all clients in RaceSetupData with data about opponents' ships
 * 
