...
public class Client extends Thread {
  ...
  public void createGame(long seed, int maxPlayers, int numAI, int lapCount, String lobbyName)
      throws IOException {
    GameSettings thisGame = new GameSettings(seed, maxPlayers, numAI, lapCount, lobbyName,
        clientName);
