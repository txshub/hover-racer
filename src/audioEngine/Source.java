...
public class Source {
  ...
  /**
   * Set the volume of the source Currently used only for testing
   * 
   * @param volume
   ...
   * 
   * @param pitch
   *          The new volume for the pitch (1.0 = default pitch)
   */
   ...
   * 
   * @param master
   *          The value to increase/decrease the value by (between 0.0 - 1.0)
   */
