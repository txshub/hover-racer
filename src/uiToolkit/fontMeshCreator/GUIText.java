package uiToolkit.fontMeshCreator;
...
public class GUIText {
   ...
   * @param maxLineLength
   *          - basically the width of the virtual page in terms of screen width (1 is full screen
   *          width, 0.5 is half the width of the screen, etc.) Text cannot go off the edge of the
   *          page, so if the text is longer than this length it will go onto the next line. When
  ...
  public GUIText(String text, float fontSize, FontType font, Vector2f position, float maxLineLength,
    ...
    // Load the text into a batch as soon as it is created
    TextMaster.loadText(this);
  }

  /**
   * Removess the text from the screen.
   */
  public void remove() {
   ...
   * 
   * @param vao
   *          - the VAO containing all the vertex data for the quads on which the text will be
   *          rendered.
   * @param verticesCount
