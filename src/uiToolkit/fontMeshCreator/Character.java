...
public class Character {
   ...
   * @param xTextureCoord
   *          - the x texture coordinate for the top left corner of the character in the texture
   *          atlas.
   * @param yTextureCoord
   *          - the y texture coordinate for the top left corner of the character in the texture
   *          atlas.
   * @param xTexSize
