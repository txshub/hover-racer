 ...
 * Class that implements the design of the credits window,
 * that is displayed in the game menu.
 *
 */
...
public class Credits extends GridPane {
	...
	/**
	 * Constructor for the Credits class that defines
	 * the style for the UI elements.
	 */
	public Credits(){
