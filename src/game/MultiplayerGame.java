...
public class MultiplayerGame {
  ...
  public void update(float delta) {
    ...
    if (!controlsScreen.isVisible() && System.nanoTime() < controlsTill) {
      controlsScreen.setVisibility(true);
    } else if (controlsScreen.isVisible() && System.nanoTime() > controlsTill
    ...
    if (input.wasPressed(Action.MENU) > 0.5f) {
      if (currentMenu.equals("none")) {
        ...
        currentMenu = "main";
      } else if (currentMenu.equals("controls")) {
        menu.setVisibility(true);
        controlsScreen.setVisibility(false);
        currentMenu = "main";
      }
  ...
  private void setupUI(RaceSetupData data) {
    ...
    font = new FontType(loader.loadFontTexture("ui/calibri"),
    ...
    Button controlsButton = new Button(loader, "ui/ButtonBackground", new Vector2f(58, 256));
    controlsButton.setParent(menu);
    controlsButton.addListener(new ActionListener() {
    ...
    Label controlsText = new Label(loader, "CONTROLS", font, 2.5f, true, new Vector2f(0, 8), 266);
    controlsText.setParent(controlsButton);
    controlsText.setColour(textColour);
    ...
    posTotal = new Label(loader, Integer.toString(data.shipData.size()), font, 2.8f, true,
        new Vector2f(4, 2), 50);
    ...
    lapTotal = new Label(loader, Integer.toString(data.laps), font, 2.8f, true, new Vector2f(95, 2),
        50);
    ...
    controlsScreen = new Container(loader, "ui/keybindings", new Vector2f());
    containers.add(controlsScreen);

    Button controlsBackButton = new Button(loader, "ui/ButtonBackground", new Vector2f(853, 391));
    controlsBackButton.setParent(controlsScreen);
    controlsBackButton.addListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("pressed")) {
          controlsScreen.setVisibility(false);
          menu.setVisibility(true);
    ...
    Label controlsBackText = new Label(loader, "BACK", font, 2.5f, true, new Vector2f(0, 6), 266);
    controlsBackText.setParent(controlsBackButton);
    controlsBackText.setColour(textColour);

    controlsScreen.setVisibility(false);

    startLights = new Container(loader, "ui/lights0", new Vector2f(470, 40));
    containers.add(startLights);
