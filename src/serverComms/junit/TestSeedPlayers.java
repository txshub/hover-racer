...
public class TestSeedPlayers {
	...
	public void testToStringWithParams() {
		...
		if(!test.toString().equals(expected)) fail("toString not as expected with params");
	}
	...
	public void testToStringWithString() {
		...
		if(!test.toString().equals(expected)) fail("toString not as expected with string");
	}
	...
	public void testToByteArrayWithParams() {
		...
		String expected = seed + "|Player1|Player2|Player3|";
		SeedPlayers test = new SeedPlayers(seed, players);
		if(!Arrays.equals(test.toByteArray(),(expected).getBytes(ServerComm.charset))) fail("toString not as expected with params");
	}
	...
	public void testToByteArrayWithString() {
		...
		String expected = seed + "|Player1|Player2|Player3|";
		SeedPlayers test = new SeedPlayers(expected);
		if(!Arrays.equals(test.toByteArray(),(expected).getBytes(ServerComm.charset))) fail("toString not as expected with string");
	}
