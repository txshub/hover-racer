...
/**
 * Container for Client-Server communications, holds a byte to specify the type of message and also a byte array for the actual message
 * @author simon
 *
 */
public class ByteArrayByte {
   ...
   * @param typeMessage The type & message together
   */
