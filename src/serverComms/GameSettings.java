...
public class GameSettings {
  ...
  public GameSettings(long seed, int maxPlayers, int numAI, int lapCount, String lobbyName,
      String hostName) throws IllegalArgumentException {
    this.seed = seed;
  ...
  public String toString() {
    return seed + "|" + maxPlayers + "|" + numAI + "|" + lapCount + "|" + lobbyName + "|"
        + hostName;
  }
